...
asio::awaitable<int> Record::open_file(const std::string& filename) {
  ...
  m_fp = std::make_shared<asio::stream_file>(ctx, full_path, asio::file_base::create | asio::file_base::read_write 
